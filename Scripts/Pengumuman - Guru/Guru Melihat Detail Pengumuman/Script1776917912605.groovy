...
Mobile.waitForElementPresent(findTestObject('Pengumuman - Guru/detail_pengumuman_guru'), 10)
Mobile.tap(findTestObject('Pengumuman - Guru/detail_pengumuman_guru'), 10)
