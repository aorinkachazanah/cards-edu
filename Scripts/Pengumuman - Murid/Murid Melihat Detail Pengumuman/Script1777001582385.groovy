...
Mobile.waitForElementPresent(findTestObject('Pengumuman - Murid/detail_pengumuman_murid'), 10)
Mobile.tap(findTestObject('Pengumuman - Murid/detail_pengumuman_murid'), 10)
