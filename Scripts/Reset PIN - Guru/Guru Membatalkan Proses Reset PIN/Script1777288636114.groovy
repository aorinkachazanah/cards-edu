...
Mobile.waitForElementPresent(findTestObject('Reset PIN - Guru/icon_email_guru'), 20)
Mobile.tap(findTestObject('Reset PIN - Guru/icon_email_guru'), 0)

Mobile.waitForElementPresent(findTestObject('Reset PIN - Guru/konfirmasi_tidak'), 20)
Mobile.tap(findTestObject('Reset PIN - Guru/konfirmasi_tidak'), 0)
