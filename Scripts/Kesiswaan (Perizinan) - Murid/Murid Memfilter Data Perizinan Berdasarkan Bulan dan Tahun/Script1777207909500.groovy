...
Mobile.waitForElementPresent(findTestObject('Kesiswaan (Perizinan) - Murid/filter_perizinan'), 20)
Mobile.tap(findTestObject('Kesiswaan (Perizinan) - Murid/filter_perizinan'), 0)
