...
Mobile.waitForElementPresent(findTestObject('Rekap Keuangan - Guru/filter_rekap_keuangan_guru'), 20)
Mobile.tap(findTestObject('Rekap Keuangan - Guru/filter_rekap_keuangan_guru'), 0)
