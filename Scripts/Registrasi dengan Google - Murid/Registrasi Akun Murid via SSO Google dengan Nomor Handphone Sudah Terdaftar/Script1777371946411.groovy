...
Mobile.setText(findTestObject('Registrasi dengan Google - Murid/masukkan_nomor_handphone'), '85867216075', 10)
Mobile.hideKeyboard()
...
Mobile.waitForElementPresent(findTestObject('Registrasi dengan Google - Murid/batalkan_nomor_handphone'), 20)
Mobile.tap(findTestObject('Registrasi dengan Google - Murid/batalkan_nomor_handphone'), 0)
