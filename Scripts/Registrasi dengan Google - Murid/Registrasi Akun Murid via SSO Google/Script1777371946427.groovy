...
Mobile.setText(findTestObject('Registrasi dengan Google - Murid/masukkan_nomor_kartu'), '1002050566493095', 10)
Mobile.hideKeyboard()
...
Mobile.setText(findTestObject('Registrasi dengan Google - Murid/masukkan_pin_kartu'), '911870', 10)
Mobile.hideKeyboard()
